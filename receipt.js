(function () {
	...
	function updateReceiptSubtotal() {
		let receiptItemContainer = document.getElementById(
			"miniReceiptItems"
		);
		let receiptItems = receiptItemContainer.getElementsByClassName(
			"miniReceiptItem"
		);
		let total = 0;
		let totalItems = 0;
		...
		for (let i = 0; i < receiptItems.length; i++) {
			...
			let priceElement = receiptItem.getElementsByClassName(
				"receiptPrice"
			)[0];

			let quantityElement = receiptItem.getElementsByClassName(
				"receiptItemQty"
			)[0];
